...
\begin{cl}[ArrayFinderTester.java]{Standard Recursive \ttt{indexOf} Method Tester}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[ArrayFinderTailRecursiveTester.java]{Tail Recursive \ttt{indexOf} Method Tester}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[ArrayArgumentsTester.java]{Scanning for a Flag Tester} 
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[ArrayArguments.java]{Scanning for a Flag Implementation}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[ArrayArguments.java]{Main Method for Array Arguments}
\begin{lstlisting}[language=MyJava]
class ArrayArguments {
