...
class McqScoreCalculatorTester {
  ...
  static String[] E = new String[]{"A", "C", "D", "A", "B", "B", "D", "C", "C"};

  @Test
  void testScore() {    
    assertAll(
      () -> assertEquals(70.3, 
                         score(E, new String[]{"A", "C", "D", "C", "B", "B", "C", "C", "C"})),
      () -> assertEquals(100.0, 
                         score(E, new String[]{"A", "C", "D", "A", "B", "B", "D", "C", "C"})),
      () -> assertEquals(51.8,
                         score(E, new String[]{"A", "C", "?", "C", "?", "B", "?", "C", "C"})));
  }
}
\end{lstlisting}
\end{cl}
