...
class ArrayFinder {
  ...
  static int indexOf(String[] arrS, String k) {
    return indexOfHelper(arrS, k, 0);
  }

  private static int indexOfHelper(String[] arrS, String k, int i) {
