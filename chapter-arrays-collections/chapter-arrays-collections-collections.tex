...
class CommonValuesTester {
  ...
  void testCommonValues() {
    assertAll(
      () -> assertEquals(List.of(1, 3, 4), commonValues(List.of(2, 4, 1, 3, 5, 6),
                                                        List.of(1, 4, 3, 10, 20))),
      () -> assertEquals(List.of(), commonValues(List.of(10, 20, 30, 40, 50),
                                                 List.of(5, 4, 3, 2, 1))),
      () -> assertEquals(List.of(), commonValues(List.of(),
                                                 List.of(5, 4, 3, 2, 1))),
      () -> assertEquals(List.of(-2, 0, 2), commonValues(List.of(2, -2, 0, 0, -2, 2),
                                                         List.of(-2, 2, 0))))
  }
}
\end{lstlisting}
...
class ShareFirstCharacterTester {
  ...
  void testShareFirstChar() {
    ...
    assertEquals(exp2, shareFirstChar(List.of("she", "sells", "sea", "shells", "by",
                                              "the", "sea", "shore")));
  }
}
\end{lstlisting}
