...
\begin{cl}[BigIntFibStreamTester.java]{}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertEquals;
...
\begin{cl}[RemoveVowelsStreamTester/java]{Tests for \ttt{removeVowels} Method}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
...
\begin{cl}[RemoveVowelsStream.java]{Definition of \ttt{removeVowels} Using Streams}
\begin{lstlisting}[language=MyJava]
