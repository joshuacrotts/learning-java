...
class InorderTraversalTester {
  ...
  void testInorderTraversal() {
    ...
    BinarySearchTree<Integer> t2 = new BinarySearchTree<>(List.of(7, 3, 42, 1, 6, 15, 84, 26));
    assertAll(
...
class FindBetweenTester {
  ...
  void testFindBetween() {
    ...
    assertAll(
      ...
      () -> assertEquals(Set.of(1, 3, 6, 7, 15, 26, 42), findBetween(t2, 0, 100));
      () -> assertEquals(Set.of(3, 6, 7, 15, 26), findBetween(t2, 3, 26));
      () -> assertEquals(Set.of(3, 6, 7, 15), findBetween(t2, 3, 25)));
  }
}
\end{lstlisting}
