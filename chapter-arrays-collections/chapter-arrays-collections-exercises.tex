...
\exercise{1}{chapter-arrays-collections}{Design the \ttt{int[] toArray(List<Integer>} method that, when given a list of integers $l$, returns an array containing the values from $l$.}
