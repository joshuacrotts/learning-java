...
\begin{cl}[SumPrimes.java]{Sum First 100 Primes Skeleton}
\begin{lstlisting}[language=MyJava]
class SumPrimes {
...
\begin{cl}[SumPrimes.java]{Sum First 100 Primes Implementation}
\begin{lstlisting}[language=MyJava]
class SumPrimes {
...
\begin{cl}[FibonacciTester.java]{Standard Recursion Fibonacci Algorithm Tests}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[Fibonacci.java]{Standard Recursive Fibonacci Implementation}
\begin{lstlisting}[language=MyJava]
class Fibonacci {
...
\begin{cl}[Fibonacci.java]{Tail Recursive Fibonacci Implementation}
\begin{lstlisting}[language=MyJava]
class Fibonacci {
