...
\centering
\begin{tikzcd}
 P \arrow[r, "1"] & R \arrow[r, "2"] & \textit{$TR$} \arrow[r, "3"] & \textit{$TR_\mathbf{H}$} \arrow[r, "4"] & \textit{$TR_\mathbf{IVP}$} \arrow[r, "3"] & \textit{$TR_\mathbf{C}$} \arrow[r, "4"] & \textit{$TR_\mathbf{B}$} \arrow[r, "5"] & \textit{$TR_\mathbf{Ret}$} \arrow[r, dashrightarrow,""] & I
\end{tikzcd}
