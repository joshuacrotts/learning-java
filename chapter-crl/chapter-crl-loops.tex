...
\centering
\begin{tikzcd}
 P \arrow[r, dashrightarrow, ""] & R \arrow[r, dashrightarrow, ""] & TR \arrow[r, "1"] & \textit{$TR_\mathbf{H}$} \arrow[r, "2"] & \textit{$TR_\mathbf{IVP}$} \arrow[dl, "3"] & & \\
 & & & \textit{$TR_\mathbf{C}$} \arrow[r, "4"] & \textit{$TR_\mathbf{B}$} \arrow[r, "5"] & \textit{$TR_\mathbf{Ret}$} \arrow[r, dashrightarrow,""] & I
\end{tikzcd}
...
class OddReciprocalSumTester {
  ...
  void testOddRecipSum() {
    Assertions.assertAll(
      // 1/1 + 1/3 + 1/5 + 1/7.
      () -> Assertions.assertEquals(1.67619, oddRecipSum(4), DELTA),
      // Sum of zero reciprocals is zero.
      () -> Assertions.assertEquals(0, oddRecipSum(0), DELTA),
      // 1/1.
      () -> Assertions.assertEquals(1, oddRecipSum(1), DELTA),
      // 1/1 + 1/3 + 1/5 + 1/7 + 1/9 + 1/13 + ...
      () -> Assertions.assertEquals(2.26435, oddRecipSum(13), DELTA));
  }
}
\end{lstlisting}
\end{cl}
