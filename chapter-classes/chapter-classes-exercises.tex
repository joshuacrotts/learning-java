...
\exercise{1}{chapter-classes}{Add the \ttt{void set(T e, int idx)} method to the \ttt{MiniArrayList} class, which sets the element at $emph{idx}$ to the given $e$ element.}
...
\exercise{3}{chapter-classes}{This exercise has three parts.}
