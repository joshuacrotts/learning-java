...
\begin{cl}[]{Testing the \ttt{random} Method}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[]{Testing the \ttt{count} Static Variable}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[]{\ttt{Point} Class with \ttt{count} Static Variable}
\begin{lstlisting}[language=MyJava]
class Point {
...
\begin{cl}[]{Testing the \ttt{Card} Class}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[]{Testing the \ttt{Deck} Class}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[]{Testing the \ttt{Rational} Class}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[StackFrameTester.java]{}
  \begin{lstlisting}[language=MyJava]
  \end{lstlisting}
\end{cl}

\begin{cl}[StackFrameDriver.java]{}
\begin{lstlisting}[language=MyJava]
  ...
  public static BigInteger factLoop(BigInteger n) {
    ...
    while (!sf.isEmpty()) {
      ...
      if (pn.compareTo(BigInteger.ONE) <= 0) { continue; }
        ...
        sf.push(new StackFrame().addParam("n", n.subtract(BigInteger.ONE)));
        res = res.multiply(pn);
      }
    }
