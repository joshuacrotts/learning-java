...
\exercise{3}{chapter-arrays-collections}{Quine's method of truth resolution is a method of automatically reasoning about the truth of a propositional logic statement (recall the exercise from Chapter~\ref{chapter-crl}). The method is as follows:}
