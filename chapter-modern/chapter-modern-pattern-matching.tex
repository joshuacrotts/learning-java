...
class Lexer {
  ...
  public static Queue<Token> lex(String s) {
    ...
    String sWithSpaces = s.replaceAll("\\(", "( ")
            .replaceAll("\\)", " )");
...
class Parser {
  ...
  public static AstNode parse(Queue<Token> tokenList) {
    if (!tokenList.isEmpty()) {
      return switch (tokenList.peek().type()) {
        ...
        default -> throw new IllegalArgumentException("parse: unexpected token " + tokenList.peek().type());
      };
    } else { return null; }
  }
  ...
  private static AstNode parseSExpression(Queue<Token> tokenList) {
    if (tokenList.isEmpty()) { throw new IllegalArgumentException("Empty token list"); }
    else {
