...
For the uninformed, a \textit{lexer}\index{lexer} is a program that converts input into \textit{tokens}, also called a tokenizer. Tokens are components of an input string. For example, we might convert the string \ttt{"(+ 2 3)"} into five tokens: 
\begin{verbnobox}[\small]
L_PAREN "("
SYMBOL "+"
NUMBER "2"
