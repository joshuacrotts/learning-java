...
\begin{cl}[ArithmeticExceptionExample.java]{}
...
\begin{cl}[IllegalArgumentExceptionExampleTester.java]{Throwing Exceptions Tester}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[IllegalArgumentExceptionExample.java]{Throwing Exceptions} 
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[IllegalArgumentExceptionExample.java]{Catching Thrown Exceptions}
\begin{lstlisting}[language=MyJava]
class IllegalArgumentExceptionExample {
...
\begin{cl}[IndexOutOfBoundsExceptionExampleTester.java]{Out-of-bounds Access Examples}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
\begin{cl}[BadStringInputExceptionExample.java]{Bad String Input Running Example}
\begin{lstlisting}[language=MyJava]
