...
\begin{cl}[]{Examples of File Reader and Writer}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[]{Using the \ttt{PrintWriter} Class}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[]{(De-)Serializing the \ttt{Player} Class}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[]{Testing the \ttt{EmployeeScanner} Class}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[]{Reading Employee Records}
\begin{lstlisting}[language=MyJava]
...
\begin{cl}[]{Testing the \ttt{LineWordCharCounter} Class}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
