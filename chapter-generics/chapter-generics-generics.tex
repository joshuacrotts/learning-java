...
\begin{cl}[WeakGenerics.java]{Pre Java-5 ``Generics'' Example}
...
\begin{cl}[NumberListTester.java]{}
\begin{lstlisting}[language=MyJava]
import static Assertions.assertAll;
import static Assertions.assertEquals;
...
class NumberList {
  ...
  /**
    ...
    */
  public static double sum(List<? extends Number> ls) {
    return ls.stream()
