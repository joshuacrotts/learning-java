  ...
  void testMaximalMoves() {
    assertAll(
      ...
      () -> assertEquals(List.of(45, 60, 35, 25, 45, 25, 10, 15, 5), 
                         maximalMoves(List.of(20, 40, 30, 25, 45, 25, 15, 10, 5, 60, 35))));
  }
}
\end{lstlisting}
...
As we previously suggested, attempting to access an infinite stream (without a limit) causes the program to hang and eventually crash with an \ttt{OutOfMemoryError} exception.
