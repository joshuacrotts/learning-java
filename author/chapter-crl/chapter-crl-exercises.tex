...
\myexercise{1}{chapter-crl}{Design the recursive \ttt{String replaceAB(String s)} method that replaces any occurrence of the character \ttt{\q{A}\q{}} with the character \ttt{\q{B}\q{}} in a given string $s$.}
...
\end{enumerate}
If you write tests for one of these methods, you should be able to propagate it through the others, so write plenty!
