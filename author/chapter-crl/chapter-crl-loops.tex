...
\myexample{Suppose we want to compute the sum of the first~$n$ odd reciprocals.} 
...
\myexample{Suppose we want to design a program that returns the sum of the integers between two integers~$a$ and~$b$, inclusive.} 
