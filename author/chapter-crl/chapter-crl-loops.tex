...
In essence, the \ttt{StringBuilder} class allocates a buffer to store the characters of a string, and any ``append'' operations are stored in the buffer, rather than having to reallocate an entirely new string of the previous size plus the number of characters in the string-to-conjoin.
