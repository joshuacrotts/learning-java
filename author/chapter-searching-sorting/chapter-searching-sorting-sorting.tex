...
interface IHeapSort<V extends Comparable<V>> {
  AbstractSequentialList<V> heapSort(List<V> ls);
}
\end{lstlisting}
...
class FunctionalHeapSort<V extends Comparable<V>> 
                          implements IHeapSort<V> {

  @Override
  public AbstractSequentialList<V> heapSort(List<V> ls) {
    PriorityQueue<V> pq = new PriorityQueue<>(ls);
