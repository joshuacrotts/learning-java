...
We choose a pivot~$p$ at random, then create three sublists $l_<$, $l_>$, $l_=$, where~$l_<$ stores all elements less than~$p$, where~$l_>$ stores all elements greater than~$p$, and~$l_=$ stores all elements equal to the pivot. 
