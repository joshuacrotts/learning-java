...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Override the \ttt{String toString()} method to return a stringified version of the matrix. As an example, \ttt{[[1, 2, 3], [4, 5, 6]]} represents the following matrix:
