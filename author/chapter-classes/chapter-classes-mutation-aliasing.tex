...
\myexample{Let's get a bit more practice with aliasing through arrays. Suppose we have the following code, and we want to fill in the assertion blanks.}
