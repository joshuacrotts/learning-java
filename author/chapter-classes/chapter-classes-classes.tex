...
For example, if the board contains the characters \ttt{'a', 'e', 'f', 'b', 'd', 'g', 'c'}, then the map should contain the following key-value pairs:

\begin{itemize}
  \item \ttt{0} $\rightarrow$ \ttt{[]}
  \item \ttt{1} $\rightarrow$ \ttt{['a']}
  \item \ttt{2} $\rightarrow$ \ttt{['a']}
  \item \ttt{3} $\rightarrow$ \ttt{['a', 'e']}
  \item \ttt{4} $\rightarrow$ \ttt{['a', 'e']}
  \item \ttt{5} $\rightarrow$ \ttt{['a', 'e', 'f']}
  \item \ttt{6} $\rightarrow$ \ttt{['a', 'e', 'f']}
\end{itemize}
