...
We will design two \ttt{add} methods, where one receives a character to insert and another that receives a string, where each character thereof is added. As an additional simplification, all letters will be converted into their lowercase counterparts and, if a non-alphabetic character is passed, we do nothing.
