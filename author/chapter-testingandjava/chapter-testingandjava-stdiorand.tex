...
We need to instead use \ttt{nextLine}. T
...
This is because of how both \ttt{nextInt} and \ttt{nextLine} work: \ttt{nextInt} consumes all data up to but excluding an integer from the input stream; ignoring any preceding whitespaces. 
